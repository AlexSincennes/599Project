...
public class GhostMovement : MonoBehaviour {
	...
	void LateUpdate () {
        transform.position = Vector3.SmoothDamp(transform.position, new Vector3((transform.position.x + Vector3.right.x * movementSpeedX * Time.deltaTime), (transform.position.y + Vector3.up.y* movementSpeedY * Time.deltaTime), this.transform.position.z), ref velocity, 0.00001f);
