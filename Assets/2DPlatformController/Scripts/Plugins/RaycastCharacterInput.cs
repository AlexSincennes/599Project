...
{	
	...
	/// <summary>
	/// Was the swim button pressed this frame.
	/// </summary>
	virtual public bool swimButtonDown{get; protected set;}

	/// <summary>
	/// Is the command for passing down through a passthrough platform being sent.
	/// </summary>
